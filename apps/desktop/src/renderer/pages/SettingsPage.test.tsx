...
describe("SettingsPage", () => {
  ...
  it("explains cloud processing and local retention without exposing secrets", () => {
    ...
    expect(markup).toContain("Echo captures microphone audio only while a dictation recording is active");
    ...
    expect(markup).toContain("Raw transcripts and refined outputs are retained only in local History");
