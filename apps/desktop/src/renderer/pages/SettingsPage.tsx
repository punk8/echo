  ...
  return (
    <section className="page-stack settings-page">
      ...
      <section className="privacy-summary" aria-labelledby="privacy-heading">
        ...
        <ul>
          <li>Echo captures microphone audio only while a dictation recording is active.</li>
          <li>
            Audio is sent to the configured speech provider, then refined text is generated by the configured language
            model.
          </li>
          <li>Raw transcripts and refined outputs are retained only in local History when retention is enabled.</li>
          <li>
